# Glimpse - Endings Matrix

Space Edu-tainment VNRPG | Ren'Py | Crew Unity / Breakthrough

| Crew Unity / Breakthrough | High Break | Mid Break | Low Break | No Break |
|------|-------|------------|------|----|
| High Unity | Crew sets up a base and is able to return home | Crew sets up a base | Crew sets up an orbital station | Crew meets aliens | 
